...
class CartAdmin(admin.ModelAdmin):
    list_display = ('id', 'customer', 'total_items', 'subtotal', 'tax', 'total', 'completed', 'completed_at', 'created_at', 'updated_at')
    list_filter = ('completed', 'created_at')
    search_fields = ('customer__user__email', 'customer__customer_id')
    readonly_fields = ('total_items', 'subtotal', 'tax', 'total', 'completed_at', 'created_at', 'updated_at')
